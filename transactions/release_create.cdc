...
transaction(
    ...
    execute {
        ...
        // mint singles for release to complete release
        // todo: fine for now but let's move this so that users can submit multiple transactions to mint singles
        // in the case that they cannot mint all of the singles for a release in only one transaction
